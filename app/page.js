...
export default function Home() {
  return (
    <main className="w-full flex-col md:flex-row mb-10 flex grow justify-center gap-2 sm:gap-4 md:gap-6 lg:gap-8 items-center lg:justify-around">
      <div className=" md:w-80 xl:w-96 lg:flex-none hidden md:flex  max-h[90%] mx-4 min-h-[20%] border p-2 rounded-md ">
      ...
      <div className=" md:w-80 xl:w-96 lg:flex-none  flex max-h[90%] mx-4 min-h-[20%] border p-2 rounded-md ">
        family
      </div>
    </main>
  );
